...
module "mgmt-vnet" {
  ...
  private_dns_zone_id = data.terraform_remote_state.fed_core.outputs.core_la_id #Value is an input of a Map of Private DNS zone names to their resource IDs
